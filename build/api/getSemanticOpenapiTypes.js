...
export const GET = async (request) => {
    ...
    try {
        ...
        const typescriptFileString = await compile(jsonSchema, name || "SdkClient");
        ...
        console.log(e);
        return new Response(`Could not fetch schema: ${e.code} = ${e.name} (${e.message})`, { status: 404 });
    }
};
//# sourceMappingURL=getSemanticOpenapiTypes.js.map